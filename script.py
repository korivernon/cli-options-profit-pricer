...
class Option:
    ...
    def __repr__(self):
        ...
        return ret
    def __str__(self):
        ret = str(self.tkr)+ " " + str(self.max) + " " +str(self.typ) + " Option with buy in price of "+ str(self.buy)+" dollars, sale price of "+str(self.sale)+" dollars and profit of "+ str(self.profit)+" dollars."
        return ret
def print_menu():
    make_white("==============Menu================")
